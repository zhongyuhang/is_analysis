...
## 2. 业务流程（顺序图） [源码](../main/StudentList.puml)
![sequence1](../../StudentList.png) 

## 3. 界面设计
- 界面参照: https://github.com/zhongyuhang/is_analysis/blob/master/test6/src/ui/student.png
- API接口调用
    - 接口1：[getStudents](../mapper/getStudent.md) 
